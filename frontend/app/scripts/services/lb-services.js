...
/**
 * @ngdoc object
 * @name lbServices.Command
 * @header lbServices.Command
 * @object
 *
 * @description
 *
 * A $resource object for interacting with the `Command` model.
 *
 * ## Example
 *
 * See
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name lbServices.Command#prototype$__findById__event
         * @methodOf lbServices.Command
         *
         * @description
         *
         ...
         * <em>
         * (The remote method definition does not provide any description.
         * This usually means the response is a `Command` object.)
         * </em>
         */
        "prototype$__findById__event": {
          url: urlBase + "/Commands/:id/event/:fk",
          method: "GET",
        },

        /**
         * @ngdoc method
         * @name lbServices.Command#prototype$__destroyById__event
         * @methodOf lbServices.Command
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Command#prototype$__updateById__event
         * @methodOf lbServices.Command
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Command#prototype$__get__event
         * @methodOf lbServices.Command
         *
         * @description
         *
         * Queries event of Command.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
        ...
        /**
         * @ngdoc method
         * @name lbServices.Command#prototype$__create__event
         * @methodOf lbServices.Command
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Command#prototype$__delete__event
         * @methodOf lbServices.Command
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Command#prototype$__count__event
         * @methodOf lbServices.Command
         *
         * @description
         *
         * Counts event of Command.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
        ...
        "prototype$__count__event": {
          url: urlBase + "/Commands/:id/event/count",
          method: "GET",
        },

        /**
         * @ngdoc method
         * @name lbServices.Command#create
         * @methodOf lbServices.Command
         *
         * @description
         *
         ...
         */
        "create": {
          url: urlBase + "/Commands",
          method: "POST",
        },

        /**
         * @ngdoc method
         * @name lbServices.Command#upsert
         * @methodOf lbServices.Command
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Command#exists
         * @methodOf lbServices.Command
         *
         * @description
         *
         ...
         */
        "exists": {
          url: urlBase + "/Commands/:id/exists",
          method: "GET",
        },

        /**
         * @ngdoc method
         * @name lbServices.Command#findById
         * @methodOf lbServices.Command
         *
         * @description
         *
         ...
         */
        "findById": {
          url: urlBase + "/Commands/:id",
          method: "GET",
        },

        /**
         * @ngdoc method
         * @name lbServices.Command#find
         * @methodOf lbServices.Command
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Command#findOne
         * @methodOf lbServices.Command
         *
         * @description
         *
         ...
         */
        "findOne": {
          url: urlBase + "/Commands/findOne",
          method: "GET",
        },

        /**
         * @ngdoc method
         * @name lbServices.Command#updateAll
         * @methodOf lbServices.Command
         *
         * @description
         *
         ...
         */
        "updateAll": {
          url: urlBase + "/Commands/update",
          method: "POST",
        },

        /**
         * @ngdoc method
         * @name lbServices.Command#deleteById
         * @methodOf lbServices.Command
         *
         * @description
         *
         ...
         */
        "count": {
          url: urlBase + "/Commands/count",
          method: "GET",
        },

        /**
         * @ngdoc method
         * @name lbServices.Command#prototype$updateAttributes
         * @methodOf lbServices.Command
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Command#visualization
         * @methodOf lbServices.Command
         *
         * @description
         *
         ...
         */
        "visualization": {
          url: urlBase + "/Commands/visualization",
          method: "GET",
        },
      }
    );
        ...
        /**
         * @ngdoc method
         * @name lbServices.Command#updateOrCreate
         * @methodOf lbServices.Command
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Command#update
         * @methodOf lbServices.Command
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Command#destroyById
         * @methodOf lbServices.Command
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Command#removeById
         * @methodOf lbServices.Command
         *
         * @description
         *
    ...
    /**
    * @ngdoc property
    * @name lbServices.Command#modelName
    * @propertyOf lbServices.Command
    * @description
    * The name of the model represented by this $resource,
    * i.e. `Command`.
    */
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Level.maps.findById() instead.
        "prototype$__findById__maps": {
          url: urlBase + "/Levels/:id/maps/:fk",
          method: "GET",
        },

        // INTERNAL. Use Level.maps.destroyById() instead.
        "prototype$__destroyById__maps": {
          url: urlBase + "/Levels/:id/maps/:fk",
          method: "DELETE",
        },

        // INTERNAL. Use Level.maps.updateById() instead.
        "prototype$__updateById__maps": {
          url: urlBase + "/Levels/:id/maps/:fk",
          method: "PUT",
        },

        // INTERNAL. Use Level.maps() instead.
        "prototype$__get__maps": {
          url: urlBase + "/Levels/:id/maps",
          method: "GET",
          isArray: true,
        },

        // INTERNAL. Use Level.maps.create() instead.
        "prototype$__create__maps": {
          url: urlBase + "/Levels/:id/maps",
          method: "POST",
        },

        // INTERNAL. Use Level.maps.destroyAll() instead.
        "prototype$__delete__maps": {
          url: urlBase + "/Levels/:id/maps",
          method: "DELETE",
        },

        // INTERNAL. Use Level.maps.count() instead.
        "prototype$__count__maps": {
          url: urlBase + "/Levels/:id/maps/count",
          method: "GET",
        },
    ...
    */
    ...
    /**
     * @ngdoc object
     * @name lbServices.Level.maps
     * @header lbServices.Level.maps
     * @object
     * @description
     *
     * The object `Level.maps` groups methods
     * manipulating `Map` instances related to `Level`.
     *
     * Call {@link lbServices.Level#maps Level.maps()}
     * to query all related instances.
     */
         ...
         */
        R.maps = function() {
          var TargetResource = $injector.get("Map");
          var action = TargetResource["::get::Level::maps"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Level.maps#count
         * @methodOf lbServices.Level.maps
         *
         * @description
         *
         * Counts maps of Level.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
         ...
         *  - `count` – `{number=}` - 
         */
        R.maps.count = function() {
          var TargetResource = $injector.get("Map");
          var action = TargetResource["::count::Level::maps"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Level.maps#create
         * @methodOf lbServices.Level.maps
         *
         * @description
         *
         * Creates a new instance in maps of this model.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
         ...
         * </em>
         */
        R.maps.create = function() {
          var TargetResource = $injector.get("Map");
          var action = TargetResource["::create::Level::maps"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Level.maps#destroyAll
         * @methodOf lbServices.Level.maps
         *
         * @description
         *
         * Deletes all maps of this model.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
         ...
         * This method returns no data.
         */
        R.maps.destroyAll = function() {
          var TargetResource = $injector.get("Map");
          var action = TargetResource["::delete::Level::maps"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Level.maps#destroyById
         * @methodOf lbServices.Level.maps
         *
         * @description
         *
         * Delete a related item by id for maps
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
         *
         *  - `fk` – `{*}` - Foreign key for maps
         *
         * @param {function(Object,Object)=} successCb
         *   Success callback with two arguments: `value`, `responseHeaders`.
         *
         ...
         *  - `` – `{undefined=}` - 
         */
        R.maps.destroyById = function() {
          var TargetResource = $injector.get("Map");
          var action = TargetResource["::destroyById::Level::maps"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Level.maps#findById
         * @methodOf lbServices.Level.maps
         *
         * @description
         *
         * Find a related item by id for maps
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
         ...
         * </em>
         */
        R.maps.findById = function() {
          var TargetResource = $injector.get("Map");
          var action = TargetResource["::findById::Level::maps"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Level.maps#updateById
         * @methodOf lbServices.Level.maps
         *
         * @description
         *
         * Update a related item by id for maps
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
         ...
         * </em>
         */
        R.maps.updateById = function() {
          var TargetResource = $injector.get("Map");
          var action = TargetResource["::updateById::Level::maps"];
          return action.apply(R, arguments);
        };
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Level.maps.destroyById() instead.
        "::destroyById::Level::maps": {
          url: urlBase + "/Levels/:id/maps/:fk",
          method: "DELETE",
        },

        // INTERNAL. Use Level.maps.updateById() instead.
        "::updateById::Level::maps": {
          url: urlBase + "/Levels/:id/maps/:fk",
          method: "PUT",
        },
